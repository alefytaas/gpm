...
class EscalasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create escala" do
    assert_difference("Escala.count") do
      post escalas_url, params: { escala: { id_medico_adm: @escala.id_medico_adm, mes_ref: @escala.mes_ref, setor: @escala.setor } }
    end
  ...
  test "should update escala" do
    patch escala_url(@escala), params: { escala: { id_medico_adm: @escala.id_medico_adm, mes_ref: @escala.mes_ref, setor: @escala.setor } }
